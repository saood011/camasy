...
class Staff extends Component {
  ...
  async onAvailabilityChange(_id, isAvailable) {
    await axios
      .put(`/api/staff/availability/${_id}`, { isAvailable: !isAvailable })
      .then(res => console.log(res))
      .catch(err => console.log(err));
    await this.props.getStaffDetails();
  }
                ...
                <td>
                  {el.isAvailable ? (
                    <button
                      ...
                      title="Click to set Unavailable"
                      onClick={() =>
                        this.onAvailabilityChange(el._id, el.isAvailable)
                      }
                    >
                      Available
                    </button>
